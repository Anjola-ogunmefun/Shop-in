<template>
  <section>
    ...
    <base-button>
      <li class="nav-item mr-2" @click="changeSelectedTab('the-market')">
        <a
          class="btn btn-outline-danger btn-lg"
          :class="{ highlight: selectedTab === 'the-market' }"
          >List item</a
        >
      </li>
      <li class="nav-item" @click="changeSelectedTab('my-cart')">
        <a
          class="btn btn-outline-danger btn-lg"
          :class="{ highlight: selectedTab === 'my-cart' }"
          >My cart</a
        >
      </li>
    </base-button>
      ...
      allItems: [
        {
          ...
          price: 5570,
          url:
            "https://foodstuffmarket.com/wp-content/uploads/2015/04/mama-pride-rice-foodstuffmarket-3.png",
        },
        {
          id: 2,
